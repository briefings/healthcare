...
class TotalBedsCOVID:
    ...
    def __init__(self, uri):
        ...
        self.data = Data._make(('Total Beds Occupied Covid', 'C:KM', 24, 515))

        FieldNames = collections.namedtuple(typename='FieldNames', field_names=['cells', 'row'])
        self.fieldnames = FieldNames._make(('F:KM', 13))

        self.notes = "Provider Level Data - Total beds - occupied by confirmed COVID-19 patients (as at 08:00)"
